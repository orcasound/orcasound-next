...
- This structure is mirrored in `esp32_ui` at `docs/architecture/*`.
...
- [ ] Step 4: Telemetry integration design
...
## Current Focus
- Active step: Step 4
- Goal: Design telemetry integration boundaries using typed hooks and shared state rules.
